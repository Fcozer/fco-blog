...
const AddComment = ({ postId }: Props) => {
  ...
  return (
    <div className="mt-14">
      ...
      <form
        className="flex flex-col border dark:border-white shadow-sm rounded px-8 pt-6 pb-6 mb-10"
        onSubmit={handleSubmit((data) => onSubmit(data))}
      >
        <label>Name</label>
        <input
          {...register("name", { required: true })}
          className="mb-4 py-1 text-black dark:bg-off-white"
        />
        {errors.name && (
        ...
        <input
          className={`cursor-pointer bg-blue text-white rounded py-2 hover:bg-blue ${
